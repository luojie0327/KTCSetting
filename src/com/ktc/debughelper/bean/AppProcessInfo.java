...
public class AppProcessInfo implements Comparable<AppProcessInfo> {
    ...
    public String toString() {
        return "AppProcessInfo [appName=" + appName + ", processName="
                + processName + ", pid=" + pid + ", uid=" + uid + ", icon="
                + icon + ", memory=" + memory + ", cpu=" + cpu + ", status="
                + status + ", threadsCount=" + threadsCount + ", checked="
                + checked + ", isSystem=" + isSystem + "]";
    }
